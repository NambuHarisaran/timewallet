...
const _steps = <_Step>[
  _Step(Icons.hourglass_bottom, AppColors.heroNeutral, 'Money is time',
      'Every rupee is shown as the work-time it costs you. ₹500 might be 1 hour of your life. Not on a fixed salary? Founders set what their own hour is worth.'),
  ...
  _Step(Icons.search_outlined, AppColors.heroNeutral, 'Check before you buy',
      'Tap "Worth it?" or drop in any price to see it as work-hours first — decide with your time, not just your money.'),
  ...
  _Step(Icons.subscriptions_outlined, AppColors.heroWarn, 'Spot the silent drains',
      'Add your subscriptions and see the quiet ₹199-a-month leaks as the work-days they cost you every year.'),
  _Step(Icons.trending_down_rounded, AppColors.heroWarn, 'Your real hourly wage',
      'Add commute time and work-only costs to reveal your true wage — usually lower than the number on your payslip.'),
  ...
  _Step(Icons.savings_outlined, AppColors.heroPositive, 'Plan the big decisions',
      'The Plan tab holds seven planning engines (asset allocation, health score, SWP, debt, child-legacy, retirement) plus quick calculators — SIP, FD, inflation and a financial-freedom countdown.'),
